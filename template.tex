...
\title{Unfolding the City: \wq{Exploring Urban Spatial Attractiveness with Social Characteristics}}
...
\wq{Spatial attractiveness is an important concept in GIS. Explain why. To derive the details, we interview the expert in GIS. Some questions like, how citizens live in the city, where they live, work and entertain? Which place is popular? For different citizens, whether a place has the same attraction? ... With these questions, we summarize them into the tasks below, which need to be answered by our system.} \lm{Below are some core research concerns derived from domain exports.}


\textbf{Spatial Attractiveness} \lmc{Can we find some reference about Spatial Attractiveness. If not, we can give an explaination by ourselves.}

\textbf{Attractiveness Diversity} \lmc{Same...}

\textbf{Attractiveness Differences} \lmc{Same...}
...
\wq{\subsection{A glyph design details (in view3)}
We design a kind of glyph to express a high-dimensional travel indicators. It will be embeded in the map view\wqc{for case1}.}


\wq{\subsection{Ranking or comparison method (in view4)}
\wqc{for case3}We design ranking/comparison method with different weight of different purpose or different groups.}
...
\wqc{Aim1: use view1 and view2 for groups. Aim2: show their basic activity spaces.}
...
\wqc{paragraph below may be deleted. It is about attractiveness entropy, which in case3}
...
\wqc{aim: select one purpose; View3 shows spatial attractiveness, including: quantity, distance, （direction）; View4 shows ranking of origins, (or others); (add a interaction in view5 for citizens in selected grid.)}

\wq{Due to the various functions of the areas, for different space, the attractiveness for different aims differs. Therefore, in this case, we demonstrate the use of the system for exploring the spatial attractiveness for one purpose.}
