...
With the visual mapping, the profiles varies from individual to individual. By concretizing the attributes which otherwise is too abstract to percept, users can scan and search for interesting target organically in figures. For example, Figure~\ref{fig:div_example} lists the top profiles filtered by jobs, in descending order. Textual number beneath the profile is the number of individual with same characteristics. It is found that the majority of workmen earn low and have no residential license. For the officers, all of them have residential licensemost and most of them has house. Some of retired people are in old age. Most of managers are at undergraduates, even graduates. 
...
\begin{figure}[htb!]
 ...
 \caption{Top filtered profiles categoriesd job}
