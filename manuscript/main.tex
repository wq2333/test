...
%In this work, we present \textit{InVis}, a visual technique that enhances the interactive capability of existing web-based visualizations. Different from toolkits which author interactions during the visualization construction, \textit{InVis} takes existing visualizations as input and provides users with a suite of interactions driven by the visual information. Without accessing the underlying data or process how the visualization is constructed, this method leverages user understanding in visualization to address the meaning of interaction, such as data decoding, filtering, result introduction, etc. \textit{InVis} is application-independent and can be employed in various visualizations on the web. We demonstrate its usage in two scenarios \m{and evaluate its effectiveness with a qualitative user study}.
\end{abstract}
