...
\title{Visual Exploration of Human Mobility with Diverse Demographic Characteristics}
...
\begin{abstract}
A city is shaped not only by its natural geographic environment but also the population living inside it. Movement of individuals with diverse demographic characteristics sculptures the landscape of urban dynamics into multiple geo-temporal spaces, as the Sci-Fi \textit{Folding Beijing} delievered. Landed by a census experiment via Wechat to collect profiles and movements from a wide range of volunteers, this work presents a visual analytic system to unfold those active spaces of flows of people with different demographical characteristics. With a data-driven profile visualization method for intuitive visual perception of individuals, the system supports users to effectively identify characteristic flows of people. Given a flow of people, the spatial-temporal clustering method frames the active space based on traffic analysis zones, which is visualized in a 2.5D spatial visualization with flexbile exploring functions, including detail information retrieval, small multiple comparison, etc. 
Finally, we present a case study of Shenzhen to show the effectiveness and usability of our method.
