...
\begin{itemize}
  \item \textit{Diversity of spatial attractiveness} Two types of diversity: diversity of the attracted persons, and diversity of attractiveness indicators. \wqc{cannot find this concept in papers, and, i am not sure about ``indicator"}
  \item \textit{Magnitude of spatial attractiveness} How many persons could be attracted and how much the difficulty they overcome. \wqc{there is equation in related paper to support this.}
\end{itemize}
...
The elements may be included in the glyph:
\begin{itemize}
  \item how many kinds of purpose?
...
\wq{As Figure~\ref{case2draft} shows, in view3, glyph represents $\textbf{the quantity}$ and $\textbf{value of mixture of purposes}$. \wqc{(if we decide to give a computing equation to define it.)} in view4, ranking of each grid based on the quantity of each purpose.}
\begin{figure}[htb!]
 \centering % avoid the use of \begin{center}...\end{center} and use \centering instead (more compact)
