...
\wqc{A octagon radar graph to position all citizens. A clustering algorithm for commend similar persons into a new group.(maybe: interactions to set the weight of each characteristic)}
