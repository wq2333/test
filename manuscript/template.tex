...
\title{Unfolding the City: \wq{Exploring Urban Spatial Attractiveness with Individual Social Characteristics}}
...
\begin{itemize}
  \item \textit{Spatial attractiveness} How many persons could be attracted and how much the difficulty they overcome. \wqc{there is equation in related paper to support this.} \lmc{can you expand the spatial attractivenss, such as citing existing paper, explaining the concept, maybe with the equation is better.}
...
\begin{figure}[htb!]
 ...
 \caption{\wq{star-like glyph for a group of citizens.}}
 \label{fig:interfaceDraft}
\end{figure}
...
We design a kind of glyph to express a high-dimensional travel indicators. It will be embeded in the map view. \wqc{lack of a FIGURE}
...
\wqc{aim: select one purpose to show how many and where and how long.}
...
\wq{As Figure~\ref{case3draft} shows, in view3, glyph represents $\textbf{the quantity}$ and $\textbf{how many grids are linked(i.e. area)}$ and $\textbf{distribution of distances}$. }
\begin{figure}[htb!]
 \centering % avoid the use of \begin{center}...\end{center} and use \centering instead (more compact)
 \includegraphics[width=\columnwidth]{pictures/c2-s2-53}
 \caption{For purpose of shopping: (a) the rich; (b) the poor.}
 \label{case3draft}
\end{figure}


\wq{After clicking a target grid, show $\textbf{where are the linked grids}$ and $\textbf{the quantity of each linked grid}$ and $\textbf{distance}$. Compare two grid which have similar quantity, the distributions differ.}
\begin{figure}[htb!]
 \centering % avoid the use of \begin{center}...\end{center} and use \centering instead (more compact)
 \includegraphics[width=\columnwidth]{pictures/c2-click-s2-53}
 \caption{For purpose of shopping: (a) spatial attractiveness of the poor; (b) Grid1; (c) Grid2.}
 \label{case3draft}
\end{figure}
...
\subsection{Case 3: Diversity of spatial attractiveness of indicators}
...
\begin{figure}[htb!]
 \centering % avoid the use of \begin{center}...\end{center} and use \centering instead (more compact)
 \includegraphics[width=\columnwidth]{pictures/c3-53}
